                                            ...
                                            <table className='table table-bordered'>
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input type='date' className='form-control' value="" onChange={(e) => seteDate(e.target.value)}
                                                         value={email} /></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Amount</th>
                                                        <td><input type='number' className='form-control' value="" onChange={(e) => setAmnt(e.target.value)} 
                                                        value={amnt} /></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Remarks</th>
                                                        <td><input type='text' className='form-control' value="" onChange={(e) => setRmrk(e.target.value)} 
                                                        value={rmRk} /></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Type</th>
